...
export default function CoursePage() {
  ...
  const handleDownloadFile = useCallback((fileId: string) => {
    // Since files is a dependency, this callback changes when files change.
    // However, it does NOT change when searchQuery changes (which is the goal of avoiding re-renders during search).
